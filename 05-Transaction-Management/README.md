...
link from [vlad mihalcea - spring-transaction-best-practices](https://vladmihalcea.com/spring-transaction-best-practices/)
...
###### 2_2_Test_app_without_Trasnactional_but_throws_exception

<img src="https://img.shields.io/badge/- 2.2. Test_app_without_Trasnactional_but_throws_exception %20- green" height=30px>
...
With `Propagation.NOT_SUPPORTED` , if the `addEmployee()`  method is called directly , it DOES NOT create it's own new Transaction.

![image](https://user-images.githubusercontent.com/36256986/209450087-b5da93a4-df8c-4a1d-b92c-15e89a71a1ea.png)

### [Calling addEmployee() from another service](#-)

if the `addEmployee()`  method is called **from another service (OrganizationServiceImpl)**
1. It doesn't matter if the calling service has or DOES NOT have a @Transaction , the method addEmloyee will run w/o transaction.

So, 
* calling service * `joinOrganization()` method is defined with `@Transactional Propagation.REQUIRED` </br>
* `addEmployee()` method is defined `@Transactional Propagation.NOT_SUPPORTED`

![image](https://user-images.githubusercontent.com/36256986/209450194-b3d5c091-6a67-4545-bf78-51649f1d3e56.png)
...
###### 3_4_Test_app_with_Propagation_REQUIRES_NEW
...
![image](https://user-images.githubusercontent.com/36256986/209450868-65e22661-e341-49fb-9315-da8c41cc0cce.png)

### [Calling addEmployee() from another service](#-)

if the `addEmployee()`  method is called **from another service (OrganizationServiceImpl)**
1. It doesn't matter if the calling service has or DOES NOT have a @Transaction , the method addEmloyee create it's own new Transaction.

So, 
* calling service * `joinOrganization()` method is defined with `@Transactional Propagation.REQUIRED` </br>
* `addEmployee()` method is defined `@Transactional Propagation.REQUIRES_NEW`

![image](https://user-images.githubusercontent.com/36256986/209451049-ebf14ad2-46a2-4915-95ca-52af7edc9f86.png)
...
###### 3_6_Test_app_with_Propagation_MANDATORY

<img src="https://img.shields.io/badge/- 3.6. Test_app_with_Propagation_MANDATORY %20- green" height=30px>

![image](https://user-images.githubusercontent.com/36256986/209451391-e73b6a60-f159-483a-850d-5787f75d915f.png)

So, 
* calling service * `joinOrganization()` method is defined with `@Transactional Propagation.REQUIRED` </br>
* `addEmployee()` method is defined `@Transactional Propagation.MANDATORY`
