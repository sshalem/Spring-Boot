...
For example, suppose transaction 1 updates a row. </br>
...
For example, suppose transaction 1 reads a row. </br>
...
For example, suppose transaction 1 reads a set of rows that satisfy some search criteria. </br>
