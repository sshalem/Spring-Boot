...
/*
* 
* this code get the X-XSRF token which 
* is a cookie
*/
(function() {	
	// get the cookie of XSRF, split it with the '=' sign, this will create an array
	// Take the elment in place [1] which is the XSRF token , and assign it to asrf
	xsrf = document.cookie.split("=")[1];
	
	// assign xsrf value to csrfId (which is for logout purpose) 
	csrfId.setAttribute('value',`${xsrf}`);
