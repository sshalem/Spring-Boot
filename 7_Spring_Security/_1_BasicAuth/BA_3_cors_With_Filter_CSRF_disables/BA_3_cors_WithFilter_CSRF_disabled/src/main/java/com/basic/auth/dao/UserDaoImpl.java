...
public class UserDaoImpl implements UserDao {
	...
	@Override
	public UserEntity createUser(UserRequestModel userRequestModel) throws EmailOrUserAlreadyExistException, NullPointerException {
		...
		if (userRequestModel.getUsername().isEmpty()) {
			...
			throw new EmailOrUserAlreadyExistException("Username '" + userRequestModel.getUsername() + "' already exist ");
